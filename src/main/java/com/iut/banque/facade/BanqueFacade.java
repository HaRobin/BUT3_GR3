...
public class BanqueFacade {
     ...
     *
     * @param userCde : le String de l'user qui tente de s'identifier
     * @param userPwd : le String du mot de passe qui doit être vérifié
     ...
     *
     * @param compte  : un objet de type Compte correspondant au compte qu'on veut
     *                créditer
     * @param montant : un double correspondant au montant qu'on veut créditer
     * @throws IllegalFormatException si le param montant est négatif
     */
     ...
     * @param compte  : un objet de type Compte correspondant au compte qu'on veut
     *                débiter
     * @param montant : un double correspondant au montant qu'on veut débiter
     * @throws InsufficientFundsException dans le cas où le retrait n'est pas autorisé (dépassement de
     ...
     *
     * @param numeroCompte : le numéro du compte à créer
     * @param client       : le client à qui appartient le compte
     * @throws TechnicalException     : Si l'id fourni en param�tre est déjà assigné à un autre
     *                                compte de la base
     * @throws IllegalFormatException : si le numeroCompte n'est pas du bon format
     */
     ...
     * @param numeroCompte      : le numéro du compte à créer
     * @param client            : le client à qui appartient le compte
     * @param decouvertAutorise : le decouvert autorise sur ce compte
     * @throws TechnicalException        : Si l'id fourni en param�tre est déjà assigné à un autre
     *                                   compte de la base
     * @throws IllegalFormatException    : si le numeroCompte n'est pas du bon format
     ...
     * @throws IllegalOperationException : si le compte n'a pas un solde de 0
     * @throws TechnicalException        : si le compte est null ou si le compte n'est pas un compte
     *                                   persistant.
     */
     ...
     * @param male
     * @param numeroClient
     * @throws IllegalOperationException : si le numeroClient founri en paramètre est déjà assigné à
     ...
     *
     * @param u
     * @throws IllegalOperationException si l'user est null ou si l'utilisateur n'est pas un
     *                                   utilisateur persistant.
     * @throws TechnicalException        si le manager à supprimer est le dernier dans la base
     */
     ...
     *
     * @param idCompte : String correspondant à l'ID du compte qu'on veut récupérer
     ...
     *
     * @param compte           : CompteAvecDecouvert correspondant au compte qu'on veut
     *                         modifier
     * @param nouveauDecouvert : double correspondant au nouveau montant de découvert qu'on
     *                         veut assigner
     * @throws IllegalFormatException
     * @throws IllegalOperationException
     */
