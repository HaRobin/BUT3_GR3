...
public class BanqueManager {
     ...
     * données
     *
     * @param compte  : un objet de type compte représentant le compte à créditer
     * @param montant : un double correspondant au montant à créditer
     ...
     * données
     *
     * @param compte  : un objet de type compte repr�sentant le compte à créditer
     * @param montant : un double correspondant au montant à créditer
     * @throws IllegalFormatException : si le param montant est négatif; InsufficientFundsException
     ...
     * BdD
     *
     * @param numeroCompte String correspondant au numéro de compte à créer
     * @param client       Client, objet correspondant à l'objet client auquel on veut
     *                     rajouter le compte
     ...
     * @param client            Client, objet correspondant à l'objet client auquel on veut
     *                          rajouter un compte
     * @param decouvertAutorise double correspondant au montant de découvert autorisé pour le
     *                          nouveau compte
     * @throws TechnicalException
     * @throws IllegalFormatException
     ...
     *
     * @param c Compte correspondant à l'objet à supprimer
     * @throws IllegalOperationException quand on essaie la suppression d'un compte avec un solde
     *                                   différent de 0
     ...
     * @param adresse      String pour l'adresse
     * @param male         boolean pour savoir si c'est un homme ou une femme
     * @param numeroClient String pour le numero de client
     * @throws IllegalOperationException
     ...
     *
     * @param u Utilisateur correspondant à l'objet Utilisateur à supprimer
     * @throws TechnicalException        si l'user est null ou si l'utilisateur n'est pas un
     *                                   utilisateur persistant.
     * @throws IllegalOperationException si le manager à supprimer est le dernier dans la base
     */
