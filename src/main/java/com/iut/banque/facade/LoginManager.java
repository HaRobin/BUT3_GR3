...
public class LoginManager {
     ...
     *
     * @param dao : la dao nécessaire pour le LoginManager
     */
     ...
     *
     * @param userCde : un String correspondant au userID de l'utilisateur qui
     *                cherche à se connecter
     * @param userPwd : un String correspondant au mot de passe qui doit être
     ...
     *
     * @param user : un objet de type Utilisateur (Client ou Gestionnaire) que
