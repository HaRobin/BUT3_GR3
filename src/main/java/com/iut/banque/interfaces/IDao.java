...
public interface IDao {
     ...
     *
     * @param Multiple : Données correspondant à la création d'un compte avec
     *                 découvert
     * @return CompteAvecDecouvert : l'objet compte qui a été implémenté dans la
     * base. Envoie une exception en cas d'erreur
     * @throws TechnicalException        : si le numéro de compte existe déjà IllegalFormatException : si
     ...
     *
     * @param Multiple : Données correspondant à la création d'un compte sans
     *                 découvert
     ...
     *
     * @param c : un objet de type Compte correspondant à celui qu'on veut
     ...
     *
     * @param id : String avec l'id de l'utilisateur a qui on veut récupérer la
     *           liste des comptes
     ...
     *
     * @param id : String avec l'id du compte duquel on veut récupérer l'objet
     ...
     *
     * @param Multiple : Tous les champs importants pour créer un utilisateur
     ...
     *
     * @param u : un objet de type Utilisateur (Client ou Gestionnaire)
     ...
     * passé en paramètre
     *
     * @param userId  : un String correspondant au userId à qui on veut vérifier le
     *                mot de passe
     * @param userPwd : un String correspondant au mot de passe qu'on veut
     ...
     *
     * @param id : un String correspondant à l'id de l'utilisateur auquel on
