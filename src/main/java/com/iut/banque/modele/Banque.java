...
public class Banque {
     ...
     *
     * @param accounts : Map<String,Client> correpondant au Map qu'on veut assigner
     */
     ...
     *
     * @param gestionnaires : Map<String,Gestionnaire> correpondant au Map qu'on veut
     *                      assigner
     */
     ...
     *
     * @param accounts : Map<String,Compte> correpondant au Map qu'on veut assigner
     */
