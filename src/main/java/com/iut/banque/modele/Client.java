...
public class Client extends Utilisateur {
     ...
     * @throws IllegalArgumentException , dans le cas où numéro passé en argument est vide
     ...
     *
     * @param accounts : la map passée en argument doit avoir pour clés les numéro de
     *                 compte et pour valeurs les objets Comptes.
     */
