...
public abstract class Compte {
     ...
     * Setter du solde.
     *
     * @param solde : le solde à changer
     */
     ...
     *
     * @param numeroCompte : le numéro de compte à changer
     * @throws IllegalFormatException : dans le cas où le format du numéro de compte n'est pas
     *                                correct.
     */
     ...
     * @throws InsufficientFundsException : dans le cas où le montant est trop élevé
     */
     ...
     * @throws IllegalFormatException : si le montant est négatif
     */
     ...
     *
     * @param s : String d'entrée qu'on veut comparer au format attendu
