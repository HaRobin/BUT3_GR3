...
public class CompteAvecDecouvert extends Compte {
     ...
     * @throws IllegalFormatException    : si le découvert est inférieur à 0
     ...
     *
     * @throws TechnicalException        : si le découvert autorisé est inférieur à 0
     * @throws IllegalFormatException    : si le numero de compte ne respecte pas le format
     * @throws IllegalOperationException
     */
